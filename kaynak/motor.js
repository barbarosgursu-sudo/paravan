...
class Oyun {
  ...
  masadakiVakalar() {
    ...
    // Omurga bitti = sezon bitti. Yan iş artık masaya düşmez. Yoksa borç eşiği
    // tutuyorsa YAN-C finalden SONRA masada beliriyor: "Dava Kapandı" ekranı
    // Hulki'nin arkasında kalıyor ve final mührü (cavit_ver → "Bağlı") bir
    // sonraki yan işin kararıyla siliniyordu.
    else return out;
